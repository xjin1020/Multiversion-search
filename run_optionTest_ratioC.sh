...
if [ -z "$1" ]; then
    ...
    cd ../../phase2
    # edit query
    sed -i "s/query_len = .*#!!!/query_len = $2#!!!/g" runjob_optionTest_ratioC.py
    sed -i "s/k=.*#!!!/k=$top_k#!!!/g" runjob_optionTest_ratioC.py
    ...
    echo
    python runjob_optionTest_ratioC.py &> outputTest
