...
#echo "Run query: $1"
    ...
    cd ../../phase2
    # edit query
    sed -i "s/query_len = .*#!!!/query_len = $2#!!!/g" runjob_optionTestCluster.py
    sed -i "s/k=.*#!!!/k=$top_k#!!!/g" runjob_optionTestCluster.py
...
#echo
    python runjob_optionTestCluster.py &> outputTestCluster
