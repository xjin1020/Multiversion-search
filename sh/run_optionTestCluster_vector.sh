...
#echo "Run query: $1"
    ...
    cd ../../phase2
    # edit query
    sed -i "s/query_len = .*#!!!/query_len = $2#!!!/g" runjob_optionTestCluster_vector.py
    sed -i "s/k=.*#!!!/k=$top_k#!!!/g" runjob_optionTestCluster_vector.py
...
#echo
    python runjob_optionTestCluster_vector.py &> outputTestCluster
#echo ">>>> Finish Searching using OptionTestCluster <<<<"
    python calculateTestCluster.py
