...
for line in fin.readlines():
    ...
    #run_command_n('rm dvrelation.txt')
    #run_command_n('rm vdrelation.txt')
    #run_command_n('rm index.txt')
    #run_command_n('cp ../../gen_index/gen_index ./')
    run_command_n('../../gen_index/gen_index '+line_list[1])
    #run_command_n('rm gen_index')
    os.chdir('..')
