...
public class IndexSearcher extends Searcher {
  ...
  public TopDocs search(Weight weight, Filter filter, int nDocs) throws IOException {
    ...
    TopScoreDocCollector collector = TopScoreDocCollector.create(nDocs, !weight.scoresDocsOutOfOrder());
    	//Date end2 = new Date();
    	//System.out.println("Time inside2: "+(end2.getTime()-start2.getTime())+"ms");
    Date 	start = new Date();
    search(weight, filter, collector);
    Date end = new Date();
	System.out.println("Time inside IndexSearcher.search: "+(end.getTime()-start.getTime())+"ms");
  ...
  public void search(Weight weight, Filter filter, Collector collector)
    ...
    if (filter == null) {
      ...
      Date end = new Date();
      	System.out.println("Time IndexSearcher.searchbefore: "+(end.getTime()-start.getTime())+"ms");
        if (scorer != null) {
	        	Date 	start2 = new Date();
	        //scorer.score(collector);
		    	Date end2 = new Date();
		    	System.out.println("Time IndexSearcher.search: "+(end2.getTime()-start2.getTime())+"ms");
