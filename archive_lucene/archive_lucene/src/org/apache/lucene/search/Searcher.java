...
public abstract class Searcher implements Searchable {
 ...
 public void search(Query query, Collector results)
  ...
  public TopDocs search(Query query, Filter filter, int n)
    throws IOException {
	//Date 	start = new Date();
     // TopDocs temp = search(createWeight(query), filter, n);
	 //Date end = new Date();
	 //System.out.println("Time inside Searcher.search: "+(end.getTime()-start.getTime())+"ms");
    //return temp;
  ...
  protected Weight createWeight(Query query) throws IOException {
	Date 	start = new Date();
	  Weight temp = query.weight(this);
	  Date end = new Date();
	 System.out.println("Time inside Searcher.createWeight: "+(end.getTime()-start.getTime())+"ms");
