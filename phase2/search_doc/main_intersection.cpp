...
void intersection1()
{
    ...
    struct timeval dwstart2, dwend2;
    double dwtime = 0, dwtime_sort=0, dwtime_insert=0, dwtime_merge=0, dwtime1=0, dwtime2=0;
    ...
    // end timing
    gettimeofday(&dwend2, NULL);
    dwtime2 = 1000.0*(dwend2.tv_sec-dwstart2.tv_sec)+(dwend2.tv_usec-dwstart2.tv_usec)/1000.0;
    //gettimeofday(&dwend, NULL);
    //dwtime = 1000.0*(dwend.tv_sec-dwstart.tv_sec)+(dwend.tv_usec-dwstart.tv_usec)/1000.0;
    cout << "Calculate intersection time: " << dwtime2 << " ms"<< endl;
